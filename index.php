...
<html lang="en">
    ...
    <link rel="icon" href="assets/img/cropped-cropped-logo_2-32x32.png" sizes="32x32" />
    <body id="page-top">
        <!-- Navigation-->
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - <?php echo $_SESSION['setting_name'] ?> | <a href="https://www.cuz.ac.zw" target="_blank">CUZ Official Website</a></div></div>
        </footer>
