    ...
    background: yellow;
            ...
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-md-12 mb-2 text-left">
                        <div class="card">
                            <div class="card-body">
                                  <h4 class="text-center">Search Programs and Modules</h4>
        ...
        <section id="list">
            <div class="container mt-3 pt-2">
                <h4 class="text-center">Program List</h4>
                <hr class="divider">
                <?php
                $vacancy = $conn->query("SELECT * FROM program order by date(date_created) desc ");
                ...
                <div class="card vacancy-list" data-id="<?php echo $row['id'] ?>">
                    <div class="card-body">
                        ...
                        <span><small>Seats Left: <?php echo $row['availability'] ?></small></span>
                        <hr>
