				...
				<div class="card">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12">
								<div class="row">
									<div class="col-md-2 offset-md-2 text-right">Program :</div>
									<div class="col-md-5">
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$stats = $conn->query("SELECT * FROM enrollment_status order by id asc");
								$stat_arr[0] = "New";
								...
								$application = $conn->query("SELECT a.*,v.position FROM application a inner join program v on v.id = a.position_id $awhere order by a.id asc");
