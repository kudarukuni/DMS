...
<?php
	if(isset($_GET['id'])){
		$application = $conn->query("SELECT  a.*,v.position FROM application a inner join program v on v.id = a.position_id where a.id=".$_GET['id'])->fetch_array();
	...
	$rs = $conn->query("SELECT * FROM enrollment_status ");
