			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<div class="row">
							<div class="col-lg-12">
								<span><large><b>Program List</b></large></span>
								<button class="btn btn-sm btn-block btn-primary btn-sm col-md-2 float-right" type="button" id="new_vacancy"><i class="fa fa-plus"></i>Add New Program</button>
							</div>
						</div>
						...
						<table class="table table-bordered table-hover">
							...
							<thead>
								<tr>
									...
									<th class="text-center">Program Information</th>
							...
							<tbody>
								<?php 
								$i = 1;
								$plan = $conn->query("SELECT * FROM program order by id asc");
...
<script>
	...
	$("#new_vacancy").click(function(){
		uni_modal("New Program","manage_vacancy.php","mid-large")
	})
	$(".edit_vacancy").click(function(){
		uni_modal("Edit Program","manage_vacancy.php?id="+$(this).attr('data-id'),"mid-large")
	})
	...
	$('.delete_vacancy').click(function(){
		_conf("Are you sure to delete this Program?","delete_vacancy",[$(this).attr('data-id')])
	})
